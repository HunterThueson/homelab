...
- Push myself to learn new things. I want to be more efficient and effective in what I do, so for the past few years I've been dabbling in new tools like Vim and Bash scripting to help me go about my day-to-day life. In the near future I plan on breaking into a few new ones that I think will be useful (listed below).

## What I am Currently Struggling With
- ~~NixOS module option types.~~
...
- ~~Apply unified themes, color schemes, etc. with Stylix or some similar utility~~ Completed 3/12/2026
